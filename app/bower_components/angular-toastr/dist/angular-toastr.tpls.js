(function() {
  ...
  function toastr($animate, $injector, $document, $rootScope, $sce, toastrConfig, $q) {
    ...
    function error(message, title, optionsOverride, error) {
      var type = _getOptions().iconClasses.error;
      return _buildNotification(type, message, title, optionsOverride, error);
    }

    function info(message, title, optionsOverride, error) {
    ...
    /* Internal functions */
    function _buildNotification(type, message, title, optionsOverride, error) {
...
(function() {
  ...
  toast.$inject = ['$injector', '$interval', 'toastrConfig', 'toastr', 'clipboard'];

  function toast($injector, $interval, toastrConfig, toastr, clipboard) {
    return {
      templateUrl: function() {
    ...
    function toastLinkFunction(scope, element, attrs, toastCtrl) {
      ...
      scope.tapToast = function () {
        clipboard.copyText(scope.error);
